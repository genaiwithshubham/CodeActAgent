...
class CodeActAgent:
    ...
    def _construct_system_prompt(self) -> str:
        ...
        file_path = r"/Users/shubhamaggarwal/Development/genaiwithshubh/codeactagent/prompts/codeact_system_prompt.txt"
    ...
    def _process_cycle(self, user_query: str, cycle_number: int) -> Tuple[str, bool]:
        """
    ...
    def solve(self, user_query: str) -> str:
        ...
        while not complete and current_cycle <= self.max_cycles:
            cycle_response, complete = self._process_cycle(user_query, current_cycle)
...
if __name__ == "__main__":
    agent = CodeActAgent(debug=True, max_cycles=5)

    user_query = """Create a small dataset of 5 students with their names, ages, and test scores.
...
Finally, create a simple bar chart visualizing all students' scores."""
    ...
    solution = agent.solve(user_query)
    print("\n--- Final Solution ---")
    print(solution)
